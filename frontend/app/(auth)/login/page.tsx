      ...
      <div className="relative flex flex-1 items-center justify-center p-8">
        ...
        <div className="relative w-full max-w-md space-y-8">
          <div>
           ...
           <p className="mt-2 text-sm text-gray-500 text-balance">
              Access your workspace via secure credentials.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <input
              ...
              className="w-full rounded-2xl border border-white/5 bg-white/5 p-4 text-sm focus:border-sky-500/50 focus:outline-none transition-all placeholder:text-gray-600"
              required
            />
